...
import { ModelCreator, SelectInput } from './FormControls';
...
const InputScreen: React.FC<InputScreenProps> = ({ onStyleRequest, error, onBack }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-white/70 backdrop-blur-md p-4 md:p-8 rounded-2xl shadow-lg border border-orange-100">
        <h2 className="text-2xl md:text-3xl font-bold text-teal-800 mb-2">Let's Create Your Look</h2>
        <p className="text-gray-600 mb-6 md:mb-8">
          First, describe your virtual model, then upload your outfit.
        </p>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1 space-y-6">
                <ModelCreator modelDescription={modelDescription} setModelDescription={setModelDescription} />
            </div>
            <div className="lg:col-span-1 space-y-6">
